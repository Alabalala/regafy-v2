	...
	return (
		...
		>
			<path
				...
				className={`stroke-2 stroke-black dark:stroke-white ${filled ? "fill-background dark:fill-tertiary-dark" : "fill-none"} group-hover:fill-background-50 group-hover:dark:fill-tertiary-dark-50 group-active:fill-background-100 group-active:dark:fill-tertiary-dark-100`}
			/>
			<path
				d={
